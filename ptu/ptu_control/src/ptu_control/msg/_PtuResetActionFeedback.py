"""autogenerated by genpy from ptu_control/PtuResetActionFeedback.msg. Do not edit."""
import sys
...
class PtuResetActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "ptu_control/PtuResetActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ptu_control/PtuResetFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PtuResetActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = ptu_control.msg.PtuResetFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = ptu_control.msg.PtuResetFeedback()
