"""autogenerated by genpy from ptu_control/PtuGotoAction.msg. Do not edit."""
import sys
...
class PtuGotoAction(genpy.Message):
  _md5sum = "dff5912855048fb32f14f63f7f9ce0d6"
  _type = "ptu_control/PtuGotoAction"
...
"""
  ...
  _slot_types = ['ptu_control/PtuGotoActionGoal','ptu_control/PtuGotoActionResult','ptu_control/PtuGotoActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PtuGotoAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = ptu_control.msg.PtuGotoActionGoal()
      if self.action_result is None:
        self.action_result = ptu_control.msg.PtuGotoActionResult()
      if self.action_feedback is None:
        self.action_feedback = ptu_control.msg.PtuGotoActionFeedback()
    else:
      self.action_goal = ptu_control.msg.PtuGotoActionGoal()
      self.action_result = ptu_control.msg.PtuGotoActionResult()
      self.action_feedback = ptu_control.msg.PtuGotoActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4f3I.pack(_x.action_goal.goal.pan, _x.action_goal.goal.tilt, _x.action_goal.goal.pan_vel, _x.action_goal.goal.tilt_vel, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_result.result.state.name)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_result.result.state.name:
        length = len(val1)
        if python3 or type(val1) == unicode:
          val1 = val1.encode('utf-8')
          length = len(val1)
        buff.write(struct.pack('<I%ss'%length, length, val1))
      length = len(self.action_result.result.state.position)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_result.result.state.position))
      length = len(self.action_result.result.state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_result.result.state.velocity))
      length = len(self.action_result.result.state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_result.result.state.effort))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.pan, _x.action_goal.goal.tilt, _x.action_goal.goal.pan_vel, _x.action_goal.goal.tilt_vel, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_4f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (length,) = _struct_I.unpack(str[start:end])
      self.action_result.result.state.name = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_result.result.state.name.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_result.result.state.position = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_result.result.state.velocity = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_result.result.state.effort = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.action_result.result.state.position.tostring())
      length = len(self.action_result.result.state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.action_result.result.state.velocity.tostring())
      length = len(self.action_result.result.state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(self.action_result.result.state.effort.tostring())
      _x = self
      buff.write(_struct_3I.pack(_x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      _x = self.action_feedback.header.frame_id
      length = len(_x)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.action_result.result.state.position = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_result.result.state.velocity = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_result.result.state.effort = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=length)
      _x = self
      start = end
      end += 12
      (_x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
