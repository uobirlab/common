"""autogenerated by genpy from ptu_control/PtuResetActionResult.msg. Do not edit."""
import sys
...
class PtuResetActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "ptu_control/PtuResetActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ptu_control/PtuResetResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PtuResetActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = ptu_control.msg.PtuResetResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = ptu_control.msg.PtuResetResult()
