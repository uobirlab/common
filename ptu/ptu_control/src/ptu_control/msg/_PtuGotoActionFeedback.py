"""autogenerated by genpy from ptu_control/PtuGotoActionFeedback.msg. Do not edit."""
import sys
...
class PtuGotoActionFeedback(genpy.Message):
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ptu_control/PtuGotoFeedback']
