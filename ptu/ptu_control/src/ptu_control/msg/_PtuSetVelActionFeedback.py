"""autogenerated by genpy from ptu_control/PtuSetVelActionFeedback.msg. Do not edit."""
import sys
...
class PtuSetVelActionFeedback(genpy.Message):
  _md5sum = "dc74f5b1dc5672546f8ac0254326bb57"
  _type = "ptu_control/PtuSetVelActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ptu_control/PtuSetVelFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PtuSetVelActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = ptu_control.msg.PtuSetVelFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = ptu_control.msg.PtuSetVelFeedback()
