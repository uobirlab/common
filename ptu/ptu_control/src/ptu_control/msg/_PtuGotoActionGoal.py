"""autogenerated by genpy from ptu_control/PtuGotoActionGoal.msg. Do not edit."""
import sys
...
class PtuGotoActionGoal(genpy.Message):
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','ptu_control/PtuGotoGoal']
